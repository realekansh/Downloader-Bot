...
async def cmd_promote(message: Message):
    ...
    await message.answer(f"User <b>{display_name}</b> promoted to admin.", parse_mode=ParseMode.HTML)
...
async def cmd_demote(message: Message):
    ...
    await message.answer(f"User <b>{display_name}</b> demoted from admin.", parse_mode=ParseMode.HTML)
...
async def cmd_add_group(message: Message):
    ...
    await message.answer(f"Group approved: <b>{group_title}</b>", parse_mode=ParseMode.HTML)
...
async def cmd_remove_group(message: Message):
    ...
    await message.answer(f"Group approval removed: <b>{group_title}</b>", parse_mode=ParseMode.HTML)
...
async def cmd_set_rank(message: Message):
    ...
    await message.answer(f"Group rank for <b>{group_title}</b> set to <b>{rank_str.title()}</b>", parse_mode=ParseMode.HTML)
